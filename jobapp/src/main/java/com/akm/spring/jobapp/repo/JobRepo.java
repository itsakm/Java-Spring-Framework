package com.akm.spring.jobapp.repo;
...
public class JobRepo {
    ...
    public JobRepo() {
        ...
        jobs.add(new JobPost(1, "Java Developer", "Must have good experience in core Java and advanced Java", 2, Arrays.asList("Core Java", "J2EE", "Spring Boot", "Hibernate")));
